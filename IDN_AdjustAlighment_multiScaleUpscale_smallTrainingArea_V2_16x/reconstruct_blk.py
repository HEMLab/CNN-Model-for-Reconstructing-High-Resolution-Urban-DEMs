...
weight_file = './snapshot_caffemodel_x16/IDN_iter_410000.caffemodel'

im_file_gt = '/home/yanghu/dataset/GeoDataLondon/DataMoreAreas/Remodelling_Area/P5M/LIDAR_Remodeling_Area1_p5m.mat'
im_file_lr = '/home/yanghu/dataset/GeoDataLondon/DataMoreAreas/Remodelling_Area/8M/LIDAR_Remodeling_Area1_8m.mat'
...
for i in xrange(0,len(mx)):
    ...
    tmpRst = np.array(net.blobs['sum_16x'].data[0,0],dtype=np.float32)
...
scipy.io.savemat('./tmpRst/LIDAR_Remodeling_Area1_8m_to_p5m.mat',rst)
