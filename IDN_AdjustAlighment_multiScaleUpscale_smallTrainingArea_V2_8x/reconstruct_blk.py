...
weight_file = './snapshot_caffemodel_x8/IDN_iter_300000.caffemodel'

im_file_gt = '/home/yanghu/dataset/GeoDataLondon/DataMoreAreas/Remodelling_Area/P5M/LIDAR_Remodeling_Area1_p5m.mat'
im_file_lr = '/home/yanghu/dataset/GeoDataLondon/DataMoreAreas/Remodelling_Area/4M/LIDAR_Remodeling_Area1_4m.mat'
...
for i in xrange(0,len(mx)):
    ...
    tmpRst = np.array(net.blobs['sum_8x'].data[0,0],dtype=np.float32)
...
rst = dict()
#rst['imLR_up']=im_lr_up
rst['imGt']=im_gt
rst['imRstFinal']=imRstFinal
#rst['imRst']=imRst
#rst['imRstWeight']=imRstWeight
scipy.io.savemat('./tmpRst/LIDAR_Remodeling_Area1_4m_to_p5m.mat',rst)
