...
model_file = './IDN_deploy_x8.prototxt'
weight_file = './snapshot_caffemodel_x8/IDN_iter_200000.caffemodel'

im_file_gt = '/home/coyh4/dataset/GeoData/London/Remodeling_Area/Remodeling_Area2/Remodeling_Area2.tif'
im_file_lr = '/home/coyh4/dataset/GeoData/London/Remodeling_Area/Remodeling_Area2/Remodeling_Area2_4m.tif'
...
im_lr = im_lr[1250:1250+int(blk_size/downsample_factor),1250:1250+int(blk_size/downsample_factor)]
#im_lr = im_lr[2000:2000+int(blk_size/downsample_factor),2250:2250+int(blk_size/downsample_factor)]
...
print net.blobs['sum_8x'].data.shape

rst = np.array(net.blobs['sum_8x'].data[0,0],dtype=np.float32)
