...
def compute_loss(net, save_dir, test_iter, layers=['loss_2x','loss_4x','loss_8x']):
...
def sr_tests(solver, test_iter, layers=['loss_2x','loss_4x','loss_8x'], saveRstPath=None, saveFilePath=None):
...
def do_sr_tests(net, solver_iter, test_iter, layers=['loss_2x','loss_4x','loss_8x'], saveRstPath=None, saveFilePath=None):
